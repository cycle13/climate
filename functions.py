...
# # Determine the UTCI for the EPW weatherfile
# def universal_thermal_climate_index(Ta, Tmrt, va, RH):
#
#     def es(ta):
#         tk = ta + 273.15 # air temp in K
#         es = 2.7150305 * np.log(tk)
#         for count, i in enumerate([-2836.5744, -6028.076559, 19.54263612, -0.02737830188, 0.000016261698, (7.0229056 * (10 ** (-10))), (-1.8680009 * (10 ** (-13)))]):
#             es = es + (i * (tk ** (count-2)))
#         es = np.exp(es) * 0.01  # convert Pa to hPa
#         return es
#
#     va = 0.5 if va < 0.5 else 17 if va > 17 else va
#
