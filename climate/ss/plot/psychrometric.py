...
import numpy as np
from climate import humidity_ratio_from_partial_vapor_pressure, humidity_ratio_from_relative_humidity, \
    dew_point_temperature_from_vapor_pressue, \
    saturation_vapor_pressure, vapor_pressure_from_humidity_ratio
