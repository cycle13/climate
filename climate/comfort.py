...
def universal_thermal_climate_index(air_temperature, mean_radiant_temperature, air_velocity, relative_humidity):
    ...
    ehPa = np.apply_along_axis(GetSatVapPres, 0, air_temperature) * 0.01 * (relative_humidity / 100.0)
    ...
    utci_approx = air_temperature + \
                  ...
                  (-0.0196701861) * np.power(air_temperature, 2) * Pa + \
                  (9.99690870E-4) * np.power(air_temperature, 3) * Pa + \
                  (9.51738512E-6) * np.power(air_temperature, 4) * Pa + \
                  (-4.66426341E-7) * np.power(air_temperature, 5) * Pa + \
                  (0.548050612) * air_velocity * Pa + \
                  (-0.00330552823) * air_temperature * air_velocity * Pa + \
                  (-0.00164119440) * np.power(air_temperature, 2) * air_velocity * Pa + \
                  (-5.16670694E-6) * np.power(air_temperature, 3) * air_velocity * Pa + \
                  (9.52692432E-7) * np.power(air_temperature, 4) * air_velocity * Pa + \
                  (-0.0429223622) * np.power(air_velocity, 2) * Pa + \
                  (0.00500845667) * air_temperature * np.power(air_velocity, 2) * Pa + \
                  (1.00601257E-6) * np.power(air_temperature, 2) * np.power(air_velocity, 2) * Pa + \
                  (-1.81748644E-6) * np.power(air_temperature, 3) * np.power(air_velocity, 2) * Pa + \
                  (-1.25813502E-3) * np.power(air_velocity, 3) * Pa + \
                  (-1.79330391E-4) * air_temperature * np.power(air_velocity, 3) * Pa + \
                  (2.34994441E-6) * np.power(air_temperature, 2) * np.power(air_velocity, 3) * Pa + \
                  (1.29735808E-4) * np.power(air_velocity, 4) * Pa + \
                  (1.29064870E-6) * air_temperature * np.power(air_velocity, 4) * Pa + \
                  (-2.28558686E-6) * np.power(air_velocity, 5) * Pa + \
                  (-0.0369476348) * mean_radiant_temperature_delta * Pa + \
                  (0.00162325322) * air_temperature * mean_radiant_temperature_delta * Pa + \
                  (-3.14279680E-5) * np.power(air_temperature, 2) * mean_radiant_temperature_delta * Pa + \
                  (2.59835559E-6) * np.power(air_temperature, 3) * mean_radiant_temperature_delta * Pa + \
                  (-4.77136523E-8) * np.power(air_temperature, 4) * mean_radiant_temperature_delta * Pa + \
                  (8.64203390E-3) * air_velocity * mean_radiant_temperature_delta * Pa + \
                  (-6.87405181E-4) * air_temperature * air_velocity * mean_radiant_temperature_delta * Pa + \
                  (-9.13863872E-6) * np.power(air_temperature, 2) * air_velocity * mean_radiant_temperature_delta * Pa + \
                  (5.15916806E-7) * np.power(air_temperature, 3) * air_velocity * mean_radiant_temperature_delta * Pa + \
                  (-3.59217476E-5) * np.power(air_velocity, 2) * mean_radiant_temperature_delta * Pa + \
                  (3.28696511E-5) * air_temperature * np.power(air_velocity, 2) * mean_radiant_temperature_delta * Pa + \
                  (-7.10542454E-7) * np.power(air_temperature, 2) * np.power(air_velocity, 2) * mean_radiant_temperature_delta * Pa + \
                  (-1.24382300E-5) * np.power(air_velocity, 3) * mean_radiant_temperature_delta * Pa + \
                  (-7.38584400E-9) * air_temperature * np.power(air_velocity, 3) * mean_radiant_temperature_delta * Pa + \
                  (2.20609296E-7) * np.power(air_velocity, 4) * mean_radiant_temperature_delta * Pa + \
                  (-7.32469180E-4) * np.power(mean_radiant_temperature_delta, 2) * Pa + \
                  (-1.87381964E-5) * air_temperature * np.power(mean_radiant_temperature_delta, 2) * Pa + \
                  (4.80925239E-6) * np.power(air_temperature, 2) * np.power(mean_radiant_temperature_delta, 2) * Pa + \
                  (-8.75492040E-8) * np.power(air_temperature, 3) * np.power(mean_radiant_temperature_delta, 2) * Pa + \
                  (2.77862930E-5) * air_velocity * np.power(mean_radiant_temperature_delta, 2) * Pa + \
                  (-5.06004592E-6) * air_temperature * air_velocity * np.power(mean_radiant_temperature_delta, 2) * Pa + \
                  (1.14325367E-7) * np.power(air_temperature, 2) * air_velocity * np.power(mean_radiant_temperature_delta, 2) * Pa + \
                  (2.53016723E-6) * np.power(air_velocity, 2) * np.power(mean_radiant_temperature_delta, 2) * Pa + \
                  (-1.72857035E-8) * air_temperature * np.power(air_velocity, 2) * np.power(mean_radiant_temperature_delta, 2) * Pa + \
                  (-3.95079398E-8) * np.power(air_velocity, 3) * np.power(mean_radiant_temperature_delta, 2) * Pa + \
                  (-3.59413173E-7) * np.power(mean_radiant_temperature_delta, 3) * Pa + \
                  (7.04388046E-7) * air_temperature * np.power(mean_radiant_temperature_delta, 3) * Pa + \
                  (-1.89309167E-8) * np.power(air_temperature, 2) * np.power(mean_radiant_temperature_delta, 3) * Pa + \
                  (-4.79768731E-7) * air_velocity * np.power(mean_radiant_temperature_delta, 3) * Pa + \
                  (7.96079978E-9) * air_temperature * air_velocity * np.power(mean_radiant_temperature_delta, 3) * Pa + \
                  (1.62897058E-9) * np.power(air_velocity, 2) * np.power(mean_radiant_temperature_delta, 3) * Pa + \
                  (3.94367674E-8) * np.power(mean_radiant_temperature_delta, 4) * Pa + \
                  (-1.18566247E-9) * air_temperature * np.power(mean_radiant_temperature_delta, 4) * Pa + \
                  (3.34678041E-10) * air_velocity * np.power(mean_radiant_temperature_delta, 4) * Pa + \
                  (-1.15606447E-10) * np.power(mean_radiant_temperature_delta, 5) * Pa + \
                  (-2.80626406) * np.power(Pa, 2) + \
                  (0.548712484) * air_temperature * np.power(Pa, 2) + \
                  (-0.00399428410) * np.power(air_temperature, 2) * np.power(Pa, 2) + \
                  (-9.54009191E-4) * np.power(air_temperature, 3) * np.power(Pa, 2) + \
                  (1.93090978E-5) * np.power(air_temperature, 4) * np.power(Pa, 2) + \
                  (-0.308806365) * air_velocity * np.power(Pa, 2) + \
                  (0.0116952364) * air_temperature * air_velocity * np.power(Pa, 2) + \
                  (4.95271903E-4) * np.power(air_temperature, 2) * air_velocity * np.power(Pa, 2) + \
                  (-1.90710882E-5) * np.power(air_temperature, 3) * air_velocity * np.power(Pa, 2) + \
                  (0.00210787756) * np.power(air_velocity, 2) * np.power(Pa, 2) + \
                  (-6.98445738E-4) * air_temperature * np.power(air_velocity, 2) * np.power(Pa, 2) + \
                  (2.30109073E-5) * np.power(air_temperature, 2) * np.power(air_velocity, 2) * np.power(Pa, 2) + \
                  (4.17856590E-4) * np.power(air_velocity, 3) * np.power(Pa, 2) + \
                  (-1.27043871E-5) * air_temperature * np.power(air_velocity, 3) * np.power(Pa, 2) + \
                  (-3.04620472E-6) * np.power(air_velocity, 4) * np.power(Pa, 2) + \
                  (0.0514507424) * mean_radiant_temperature_delta * np.power(Pa, 2) + \
                  (-0.00432510997) * air_temperature * mean_radiant_temperature_delta * np.power(Pa, 2) + \
                  (8.99281156E-5) * np.power(air_temperature, 2) * mean_radiant_temperature_delta * np.power(Pa, 2) + \
                  (-7.14663943E-7) * np.power(air_temperature, 3) * mean_radiant_temperature_delta * np.power(Pa, 2) + \
                  (-2.66016305E-4) * air_velocity * mean_radiant_temperature_delta * np.power(Pa, 2) + \
                  (2.63789586E-4) * air_temperature * air_velocity * mean_radiant_temperature_delta * np.power(Pa, 2) + \
                  (-7.01199003E-6) * np.power(air_temperature, 2) * air_velocity * mean_radiant_temperature_delta * np.power(Pa, 2) + \
                  (-1.06823306E-4) * np.power(air_velocity, 2) * mean_radiant_temperature_delta * np.power(Pa, 2) + \
                  (3.61341136E-6) * air_temperature * np.power(air_velocity, 2) * mean_radiant_temperature_delta * np.power(Pa, 2) + \
                  (2.29748967E-7) * np.power(air_velocity, 3) * mean_radiant_temperature_delta * np.power(Pa, 2) + \
                  (3.04788893E-4) * np.power(mean_radiant_temperature_delta, 2) * np.power(Pa, 2) + \
                  (-6.42070836E-5) * air_temperature * np.power(mean_radiant_temperature_delta, 2) * np.power(Pa, 2) + \
                  (1.16257971E-6) * np.power(air_temperature, 2) * np.power(mean_radiant_temperature_delta, 2) * np.power(Pa, 2) + \
                  (7.68023384E-6) * air_velocity * np.power(mean_radiant_temperature_delta, 2) * np.power(Pa, 2) + \
                  (-5.47446896E-7) * air_temperature * air_velocity * np.power(mean_radiant_temperature_delta, 2) * np.power(Pa, 2) + \
                  (-3.59937910E-8) * np.power(air_velocity, 2) * np.power(mean_radiant_temperature_delta, 2) * np.power(Pa, 2) + \
                  (-4.36497725E-6) * np.power(mean_radiant_temperature_delta, 3) * np.power(Pa, 2) + \
                  (1.68737969E-7) * air_temperature * np.power(mean_radiant_temperature_delta, 3) * np.power(Pa, 2) + \
                  (2.67489271E-8) * air_velocity * np.power(mean_radiant_temperature_delta, 3) * np.power(Pa, 2) + \
                  (3.23926897E-9) * np.power(mean_radiant_temperature_delta, 4) * np.power(Pa, 2) + \
                  (-0.0353874123) * np.power(Pa, 3) + \
                  (-0.221201190) * air_temperature * np.power(Pa, 3) + \
                  (0.0155126038) * np.power(air_temperature, 2) * np.power(Pa, 3) + \
                  (-2.63917279E-4) * np.power(air_temperature, 3) * np.power(Pa, 3) + \
                  (0.0453433455) * air_velocity * np.power(Pa, 3) + \
                  (-0.00432943862) * air_temperature * air_velocity * np.power(Pa, 3) + \
                  (1.45389826E-4) * np.power(air_temperature, 2) * air_velocity * np.power(Pa, 3) + \
                  (2.17508610E-4) * np.power(air_velocity, 2) * np.power(Pa, 3) + \
                  (-6.66724702E-5) * air_temperature * np.power(air_velocity, 2) * np.power(Pa, 3) + \
                  (3.33217140E-5) * np.power(air_velocity, 3) * np.power(Pa, 3) + \
                  (-0.00226921615) * mean_radiant_temperature_delta * np.power(Pa, 3) + \
                  (3.80261982E-4) * air_temperature * mean_radiant_temperature_delta * np.power(Pa, 3) + \
                  (-5.45314314E-9) * np.power(air_temperature, 2) * mean_radiant_temperature_delta * np.power(Pa, 3) + \
                  (-7.96355448E-4) * air_velocity * mean_radiant_temperature_delta * np.power(Pa, 3) + \
                  (2.53458034E-5) * air_temperature * air_velocity * mean_radiant_temperature_delta * np.power(Pa, 3) + \
                  (-6.31223658E-6) * np.power(air_velocity, 2) * mean_radiant_temperature_delta * np.power(Pa, 3) + \
                  (3.02122035E-4) * np.power(mean_radiant_temperature_delta, 2) * np.power(Pa, 3) + \
                  (-4.77403547E-6) * air_temperature * np.power(mean_radiant_temperature_delta, 2) * np.power(Pa, 3) + \
                  (1.73825715E-6) * air_velocity * np.power(mean_radiant_temperature_delta, 2) * np.power(Pa, 3) + \
                  (-4.09087898E-7) * np.power(mean_radiant_temperature_delta, 3) * np.power(Pa, 3) + \
                  (0.614155345) * np.power(Pa, 4) + \
                  (-0.0616755931) * air_temperature * np.power(Pa, 4) + \
                  (0.00133374846) * np.power(air_temperature, 2) * np.power(Pa, 4) + \
                  (0.00355375387) * air_velocity * np.power(Pa, 4) + \
                  (-5.13027851E-4) * air_temperature * air_velocity * np.power(Pa, 4) + \
                  (1.02449757E-4) * np.power(air_velocity, 2) * np.power(Pa, 4) + \
                  (-0.00148526421) * mean_radiant_temperature_delta * np.power(Pa, 4) + \
                  (-4.11469183E-5) * air_temperature * mean_radiant_temperature_delta * np.power(Pa, 4) + \
                  (-6.80434415E-6) * air_velocity * mean_radiant_temperature_delta * np.power(Pa, 4) + \
                  (-9.77675906E-6) * np.power(mean_radiant_temperature_delta, 2) * np.power(Pa, 4) + \
                  (0.0882773108) * np.power(Pa, 5) + \
                  (-0.00301859306) * air_temperature * np.power(Pa, 5) + \
                  (0.00104452989) * air_velocity * np.power(Pa, 5) + \
                  (2.47090539E-4) * mean_radiant_temperature_delta * np.power(Pa, 5) + \
                  (0.00148348065) * np.power(Pa, 6)
