...
class EPW(object):
    ...
    def run_gendaymtx(self, reinhart=False):
        ...
        if reinhart:
            conversion_factor = np.repeat(self.reinhart_sky_dome["patch_conversion_factor"], self.reinhart_sky_dome["patches_per_row"])
        else:
            conversion_factor = np.repeat(self.tregenza_sky_dome["patch_conversion_factor"], self.tregenza_sky_dome["patches_per_row"])
